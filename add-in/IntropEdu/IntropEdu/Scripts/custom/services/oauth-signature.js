...
; (function () {
    ...
    UrlElement.prototype = {
        ...
        parseInBrowser: function () {
            ...
            return {
                scheme: link.protocol == "https:" ? "https" : "http",
                authority: link.hostname, //url('hostname', this._url).toLocaleLowerCase(),
                port: link.port, //url('port', this._url),
                path: link.pathname //url('path', this._url)
            };
        },
